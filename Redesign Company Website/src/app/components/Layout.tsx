...
const navLinks = [
  { path: "/", label: "首页" },
  {
    ...
    path: "/products",
    children: [
      { path: "/products#led", label: "LED芯片" },
      { path: "/products#bms", label: "BMS芯片" },
      { path: "/products#lcd", label: "LCD芯片" },
      { path: "/products#power", label: "Power芯片" },
      { path: "/products#sensor", label: "传感器芯片" },
      { path: "/products#mems", label: "超声波MEMS+CMOS" },
    ],
  },
  {
    label: "解决方案",
    path: "/solutions",
    children: [
      { path: "/solutions#led-landscape", label: "LED景观照明" },
      { path: "/solutions#bms", label: "新能源BMS管理" },
      { path: "/solutions#sensor", label: "传感器应用" },
      { path: "/solutions#mems-ai", label: "超声波MEMS+AI" },
      { path: "/solutions#medical", label: "医疗电子" },
      { path: "/solutions#smart-city", label: "智慧城市" },
    ],
  },
  { path: "/rnd", label: "研发创新" },
...
const footerLinks = {
  产品中心: [
    { label: "LED芯片", path: "/products#led" },
    { label: "BMS芯片", path: "/products#bms" },
    { label: "LCD芯片", path: "/products#lcd" },
    { label: "Power芯片", path: "/products#power" },
    { label: "传感器芯片", path: "/products#sensor" },
    { label: "超声波MEMS+CMOS", path: "/products#mems" },
  ],
  解决方案: [
    { label: "LED景观照明", path: "/solutions#led-landscape" },
    { label: "新能源BMS管理", path: "/solutions#bms" },
    { label: "传感器应用", path: "/solutions#sensor" },
    { label: "超声波MEMS+AI", path: "/solutions#mems-ai" },
    { label: "医疗电子", path: "/solutions#medical" },
    { label: "智慧城市", path: "/solutions#smart-city" },
  ],
  公司: [
